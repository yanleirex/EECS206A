...
def callback(message):
    ...
    rospy.loginfo("Message: %s, Sent at: %f, Received at: %f" % (message.user_input, message.timestamp, rospy.get_time()))
...
def listener():
    ...
    rospy.Subscriber("custom_chatter_talk", TimestampString, callback)
